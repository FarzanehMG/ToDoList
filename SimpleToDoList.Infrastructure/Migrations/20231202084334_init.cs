        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Salary = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Job = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeProjectTask", x => new { x.EmployeesId, x.ProjectTasksId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeProjectTask_Task_ProjectTasksId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectProjectTask", x => new { x.ProjectTasksId, x.ProjectsId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectProjectTask_Task_ProjectTasksId",
                        column: x => x.ProjectTasksId,
                        principalTable: "Task",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeProjectTask_ProjectTasksId",
                table: "EmployeeProjectTask",
                column: "ProjectTasksId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectProjectTask_ProjectsId",
